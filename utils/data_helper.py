...
def get_generator(dataset):
    if dataset == 'luna16':
        ...
        generate_train_batches = ld2D.generate_train_batches_patches  
        generate_val_batches = ld2D.generate_val_batches_patches    
        generate_test_batches = ld2D.generate_test_batches_patches
    else:
